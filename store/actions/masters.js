...
const prepareDispatchObject = (result) => {
    ...
    result.forEach(element => {
        ...
        byParentId[element.parent_id === null ? 0 : element.parent_id].push(element);
    });

    return { byTypeValue, byParentId };
};

export { updateCstItemsByTypeValue, updateCstItemsByParentId, getCstItems, prepareDispatchObject };
